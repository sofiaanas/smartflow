# Script to extract exac regions with given depth in given % of samples, from brentp/peddy/scripts/exac-coverage-regions.py.
...
if __name__ == "__main__":
    ...
    p.add_argument("--directory", default="./", help="path to directory with ExAC coverage files")
